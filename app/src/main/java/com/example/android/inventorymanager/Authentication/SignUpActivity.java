...
public class SignUpActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSignUp.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //btnSignIn.setText("Check if verified");
                        ...
                        .addOnCompleteListener(SignUpActivity.this, new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if (!task.isSuccessful()) {
                                    ...
                                    String email = inputEmail.getText().toString().trim();
                                    String us_name = inputName.getText().toString();
                                    mUsersDatabaseReference.child(user.getUid()).child("email").setValue(email);
                                    mUsersDatabaseReference.child(user.getUid()).child("username").setValue(us_name);
